...
<!-- TODO: add closure discussion/examples -->
<style scoped>
@media screen {
...
Around 2.5 millennia ago, the pre-socratic Greek philosopher Thales of Miletus made the claim that "all is water".

Now, I am making an equally strange claim:
...
In JavaScript data and functions are much more fluid. Objects and data can be deconstructed, reconstructed, and recombined in endless combinations.
